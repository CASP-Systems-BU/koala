...
func TaxiSkewed(configFile string) *dataflow.Dataflow {
	...
	movingMedianTripTime := dataflow.NewStatefulMapper(
		...
		func(in *models.RouteInfo,
			...
			if len(mostRecentTrips) < config.ListLength {
				//log.Fatalln(len(mostRecentTrips), "new key", in.V15, in.V1, in.V2, in.V3, in.V4, in.V5, in.V6, in.V7, in.V8, in.V9, in.V10, in.V11, in.V12, in.V13, in.V14, in.V15, in.V16, in.V17)
