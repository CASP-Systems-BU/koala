...
var SampleInput []models.BidEvent = []models.BidEvent{
	{V1: 1, V2: 101, V3: 100, V4: 1, V5: "x"},
	{V1: 2, V2: 201, V3: 500, V4: 2, V5: "x"},
	{V1: 3, V2: 102, V3: 200, V4: 1, V5: "x"},
	{V1: 4, V2: 301, V3: 800, V4: 3, V5: "x"},
	{V1: 5, V2: 202, V3: 600, V4: 2, V5: "x"},
	{V1: 6, V2: 103, V3: 300, V4: 1, V5: "x"},
	{V1: 7, V2: 302, V3: 900, V4: 3, V5: "x"},
	{V1: 8, V2: 203, V3: 700, V4: 2, V5: "x"},
	{V1: 9, V2: 104, V3: 400, V4: 1, V5: "x"},
}

var SampleResult []models.BidEvent = []models.BidEvent{
	{V1: 1, V2: 101, V3: 85, V4: 1, V5: "x"},
	{V1: 2, V2: 201, V3: 425, V4: 2, V5: "x"},
	{V1: 3, V2: 102, V3: 170, V4: 1, V5: "x"},
	{V1: 4, V2: 301, V3: 680, V4: 3, V5: "x"},
	{V1: 5, V2: 202, V3: 510, V4: 2, V5: "x"},
	{V1: 6, V2: 103, V3: 255, V4: 1, V5: "x"},
	{V1: 7, V2: 302, V3: 765, V4: 3, V5: "x"},
	{V1: 8, V2: 203, V3: 595, V4: 2, V5: "x"},
	{V1: 9, V2: 104, V3: 340, V4: 1, V5: "x"},
}

var results []models.BidEvent

func TestQuery1Correctness(t *testing.T) {
	...
	numWorkers := 3
	testutils.DeployJob(numWorkers, Query1Test, config)
...
func Query1Test() *dataflow.Dataflow {
