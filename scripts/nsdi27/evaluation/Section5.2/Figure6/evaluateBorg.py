...
# fmt: off
KOALA_PATH = result_db_path("borg_lazy")
SAR_PATH = result_db_path("borg_SAR")
DRRS_PATH = result_db_path("borg_DRRS")
...
OFFSET = 20                     # shift x-axis left to hide warm-up ramp
...
target_xticks = [100,200,300,400,500,600]
for ax in axes.flat:
    ax.tick_params(axis='both', labelsize=17)
    ax.set_xticks(target_xticks)

for j in range(3):
    axes[0, j].set_yticks([0, 2e5, 4e5])
