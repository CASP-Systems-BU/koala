...
SAR_PATH = result_db_path("nexmark_query3_SAR")
DRRS_PATH = result_db_path("nexmark_query3_DRRS")

TIMES_SERIES,VALUES_SERIES_TPUT = export_metrics(DBS=[KOALA_PATH,SAR_PATH,DRRS_PATH],
    TARGET_OPERATOR="auctionSource",
