...
# fmt: off
KOALA_PATH = result_db_path("taxi_lazy")
SAR_PATH = result_db_path("taxi_SAR")
DRRS_PATH = result_db_path("taxi_DRRS")
...
SLIDING_WINDOW_SIZE = 20        # seconds of history in each sliding average
OFFSET = 60                     # shift x-axis left to hide warm-up ramp
...
for j in range(3):
    axes[0, j].set_yticks([0, 2e4, 4e4])
    axes[1, j].set_yticks([0, 30, 60])
