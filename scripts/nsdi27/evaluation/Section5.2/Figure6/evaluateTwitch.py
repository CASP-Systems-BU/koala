...
SAR_PATH = result_db_path("twitch_SAR")
DRRS_PATH = result_db_path("twitch_DRRS")
...
OFFSET = 30                     # shift x-axis left to hide warm-up ramp
...
plt.savefig("twitch.pdf", dpi=600)
# plt.show()