...
lazy_values = lazy_values[:620]
remote_values = VALUE_MAP[0][1]
remote_values = remote_values[:620]
...
plt.savefig("borg_latency.pdf", dpi=600)
# plt.show()