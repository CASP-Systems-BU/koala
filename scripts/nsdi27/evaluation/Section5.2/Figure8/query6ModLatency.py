...
REMOTE_PATH = result_db_path("nexmark_query6_modified_Remote")
...
lazy_values = lazy_values[:600]
remote_values = VALUE_MAP[0][1]
remote_values = remote_values[:600]
lazy_times = TIMES_SERIES[0]
lazy_times = lazy_times[:600]
remote_times = TIMES_SERIES[1]
remote_times = remote_times[:600]
...
plt.savefig("q6mod_latency.pdf", dpi=600)
# plt.show()