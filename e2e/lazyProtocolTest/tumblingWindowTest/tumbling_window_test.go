...
// for a tumbling window query. We verify that the number of windows and each
// counter in the windows are correct after rescaling. The results should be
// the same as the results of the tumbling window query without rescaling.
...
func TestTumblingWindowLazyProtocol(t *testing.T) {
