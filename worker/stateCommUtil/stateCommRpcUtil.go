...
// Create an LazyOptStateResponse message - used by lazy-optimized
func NewAsyncBucketMigrationResMsg(
	keys [][]byte,
	values [][]byte,
) *pb.LazyOptStateResponse {
	if keys == nil {
		return &pb.LazyOptStateResponse{
			Message: &pb.LazyOptStateResponse_StateChunk{
